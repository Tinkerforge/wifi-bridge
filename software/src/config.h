/* wifi-bridge
 * Copyright (C) 2015 Bastian Nordmeyer <bastian@tinkerforge.com>
 *
 * config.h: Wifi-Bridge specific configuration
 *
...
// LED
#define PIN_LED_STD_BLUE    {1 <<13, PIOB, ID_PIOB, PIO_OUTPUT_1, PIO_DEFAULT}
//#define PIN_LED_STD_RED     {1 << 10, PIOA, ID_PIOA, PIO_OUTPUT_1, PIO_DEFAULT}
#define PINS_STD_LED        PIN_LED_STD_BLUE
